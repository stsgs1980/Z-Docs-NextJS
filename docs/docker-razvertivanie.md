...
Голосовой режим в Docker требует двух вещей: разрешения Hermes на проверку аудиоустройств внутри контейнера и доступа контейнера к аудиосерверу хоста. Настройка ниже применима для Linux-рабочих столов с PulseAudio-совместимым сокетом (включая многие конфигурации PipeWire).
