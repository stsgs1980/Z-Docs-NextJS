...
Honcho моделирует разговоры как обмен сообщениями между peer'ами -- один user peer и один AI peer на каждый Hermes-профиль, разделяющие workspace. Workspace -- это общее окружение. Каждый AI peer строит независимую репрезентацию из собственных наблюдений.
